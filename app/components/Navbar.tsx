    ...
    <>
      <ul className="text-gray-900 flex justify-between items-center p-4 bg-gradient-to-tr from-green-200 via-green-300 to-green-400">
        <li className="flex gap-4 items-center">
          ...
          <div className="md:text-3xl text-xl font-bold">Gormandize</div>
        </li>
        <li className="font-bold text-3xl flex items-center gap-4">
          {session ? (
            <>
              ...
              >
                <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 md:text-xl text-sm">
                  Log Out
                </span>
              </button>
            </>
